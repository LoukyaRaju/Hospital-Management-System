...
<h2>ssn:</h2> <input type="number" name="ssn" value="<%=session.getAttribute("patient_id") %>" readonly>
<h2>Patient Id:</h2> <input type="number" name="patient_id" value="<%=session.getAttribute("patient_id") %>" readonly>
...
<h2>age:</h2> <input type="number" name="age" pattern="[0-3]{3}" placeholder="enter patient age (3 digits)" required>
<h2>Date:</h2>
...
<h2>city:</h2> <input type="text" name="city" placeholder="City" pattern="[A-Za-z]+" required>
